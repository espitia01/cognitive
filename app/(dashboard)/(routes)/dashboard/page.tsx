...
export default function DashboardPage() {
  ...
  return (
    <div className="mb-8 space-y-4">
      <h2 className="text-2xl md:text-4xl font-bold text-center">Cognitive Makes Data Curation Easy</h2>
      <p className="text-muted-foreground font-light text-sm md:text-lg text-center">Analyze your data using Generative AI</p>
